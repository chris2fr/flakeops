...
in
{
  containers.wagtail = {
    ...
    bindMounts = {
      ...
      "/home/wagtail/wagtailgvcoop/media" = {
        hostPath   = "/var/www/wagtailgvcoop/media";
        isReadOnly = false;
      };
      "/home/wagtail/wagtailgvcoop/static" = {
    ...
    config = { config, pkgs, ... }: {
      ...
      systemd.services.wagtail = {
        ...
        serviceConfig = {
          ...
          ExecStart = ''/home/wagtail/wagtail-lesgv/.venv/bin/gunicorn --env WAGTAIL_ENV='production' --access-logfile /var/log/wagtail/access.log --error-logfile /var/log/wagtail/error.log --chdir /home/wagtail/wagtail-lesgv --workers 12 --bind 127.0.0.1:8008 lesgv.wsgi:application'';
      ...
      systemd.services.grandv = {
        ...
        serviceConfig = {
          ...
          ExecStart = ''/home/wagtail/grandv/.venv/bin/python -m gunicorn --env WAGTAIL_ENV='production' --access-logfile /var/log/wagtail/grandv-access.log --error-logfile /var/log/wagtail/grandv-error.log --chdir /home/wagtail/grandv --workers 12 --bind 0.0.0.0:8909 settings.wsgi:application'';
      ...
      systemd.services.wagtail-gdvox = {
        description = "www.gdvox.com on 8907";
        after = [ "network.target" ];
        wantedBy = [ "multi-user.target" ];
        serviceConfig = {
      ...
      systemd.services.wagtail-gvcoop = {
        description = "www.gv.coop on 8905";
        after = [ "network.target" ];
        wantedBy = [ "multi-user.target" ];
        serviceConfig = {
