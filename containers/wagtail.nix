    ...
    config = { config, pkgs, ... }: {
      ...
      systemd.services.wagtail-resdigita-com-main = {
        ...
        serviceConfig = {
          ...
          ExecStart = ''/home/wagtail/wagtail.resdigita.com/venv/bin/gunicorn --env WAGTAIL_ENV='production' --access-logfile /var/log/wagtail/wagtail-resdigita-com-main-access.log --error-logfile /var/log/wagtail/wagtail-resdigita-com-main-error.log --chdir /home/wagtail/wagtail.resdigita.com.main --workers 12 --bind 0.0.0.0:8903 wagtailresdigitacom.wsgi:application'';
          Restart = "always";
          RestartSec = "10s";
