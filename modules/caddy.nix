      ...
      security {
        ...
        authentication portal keygvjeportal {
      	...
      	authentication portal keygdvoisinscom {
      		crypto default token lifetime 3600
      		crypto key sign-verify {env.KEYGDVOISINSCOM_JWT_SHARED_KEY}
      	...
      	authorization policy identifiedpolicy {
      		...
      		allow roles guest authp/admin authp/user
      		crypto key verify {env.KEYGDVOISINSCOM_JWT_SHARED_KEY}
        ...
        authorization policy keygvjeidentifiedpolicy {
      	...
      	authorization policy userpolicy {
      		...
      		crypto key verify {env.KEYGVOISINSCOM_JWT_SHARED_KEY}
          inject headers with claims
      	}
