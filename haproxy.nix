...
backend https-back-6
  mode tcp
  server server6 public.cp.roses.gdvoisins.com:445 maxconn 32 
  # server server6 cp.roses.gdvoisins.com:445 maxconn 32 check resolvers mynameservers
  # server server6 [::1]:445 maxconn 32
