...
let 
  ...
  listen = [
            ...
            {ip= "192.168.1.100"; port = 446 ; ssl = true ; }
            {ip= "192.168.1.100"; port = 83 ; }
            {ip= "[2a01:e0a:f4e:5880:0000:0000:9316:9fe2]"; port = 446 ; ssl = true ; }
            {ip= "[2a01:e0a:f4e:5880:0000:0000:9316:9fe2]"; port = 83 ; }
          ];
in
{ 
