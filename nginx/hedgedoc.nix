...
in
{
  services.nginx.virtualHosts = {
    ...
    # };
    "hd.gdvoisins.com" = {
      serverAliases = [ "hedgedoc.lesgrandsvoisins.com"  "hedgedoc.lesgv.org" "hedgedoc.resdigita.com" "hedgedoc.village.ngo" "hedgedoc.gv.coop" "mark.lesgrandsvoisins.com" "mark.resdigita.com" ];
      enableACME = true;
      forceSSL = true;
